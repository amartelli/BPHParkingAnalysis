...
void computeAE_charged(){
  ...
  std::string cut_genAcc = "GenPart_e2FromJPsi_index != -1 && GenPart_pt[GenPart_e2FromJPsi_index] > 1. && GenPart_eta[GenPart_e2FromJPsi_index] > -2.4 && GenPart_eta[GenPart_e2FromJPsi_index] < 2.4";
